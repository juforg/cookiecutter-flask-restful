...
class DictResource(Resource):
    ...
    def get(self, id):
        ...
        if dict:
            return return_code.SUCCESS.set_data(schema.dump(dict.__dict__)).d, 200
        else:
...
class DictList(Resource):
    ...
    def get(self):
        ...
        return return_code.SUCCESS.set_data(paginate(query, schema)), 200
...
def export_list():
    ...
    return return_code.SUCCESS.set_data(schema.dump(query.all())), 200
...
def import_excel():
    ...
    try:
        ...
        logger.exception(e)
        return return_code.UNKNOWN_ERROR.set_data(e.args)
    return return_code.SUCCESS.d, 200
...
class DictItemResource(Resource):
    ...
    def get(self, id):
        ...
        if dict_item:
            return return_code.SUCCESS.set_data(schema.dump(dict_item.__dict__)), 200
        else:
...
class DictItemList(Resource):
    ...
    def get(self, dict_code):
        ...
        return return_code.SUCCESS.set_data(schema.dump(query)), 200
