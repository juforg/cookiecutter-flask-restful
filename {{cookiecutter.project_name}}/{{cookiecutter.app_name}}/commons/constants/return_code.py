...
JSON_PARSE_FAIL = C(4000002, "JSON转换失败")
PARAM_ILLEGAL = C(4000003, "请求参数非法")
PAGE_NOT_FOUND = C(4000004, "页面不存在")
METHOD_NOT_ALLOWED = C(4000005, "方法不允许")
REPEATED_COMMIT = C(4000006, "重复提交")
USER_NOT_FOUND = C(4000007, "用户不存在")
NAME_PWD_INVALID = C(4000008, "用户名或密码错误")
